...
all_ids=[]
space_counter=0
nf= open("data/cp_kiel_train3/Psmit_lstm_yle_test_50_nbest_hyp.txt",'w')
with open('/m/triton/scratch/elec/puhe/p/jaina5/Psmit_lstm_yle_test_50_nbest_hyp', "r", encoding="utf-8") as reader:
    while True:
...
for model_dir in model_dirs:
    ...
    #             tokens.append([line])
    #     return tokens
    re=open("rescore_yle_test/rescore_yle_Psmit_lstm_1000_yle_test_50_nbest_"+model_dir,'w')
    def rescore():
        encoded_sent=corpus.vocab.encode_file(path='/m/triton/scratch/elec/puhe/p/jaina5/transformer-xl/FinnishXL/data/cp_kiel_train3/Psmit_lstm_yle_test_50_nbest_hyp.txt',add_double_eos=True)
