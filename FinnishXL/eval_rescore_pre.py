...
parser.add_argument('--data', type=str, default='/m/triton/scratch/elec/puhe/p/jaina5/transformer-xl/FinnishXL/data/kiel_left/',
...
with open('/m/triton/scratch/elec/puhe/p/jaina5/transformer-xl/FinnishXL/yle_nbest_50_pre', "r", encoding="utf-8") as reader:
    while True:
...
for model_dir in model_dirs:
    ...
    #             tokens.append([line])
    #     return tokens
    re=open("lm_cost_yle_50_nbest_rescore_pre"+model_dir,'w')
    def rescore():
