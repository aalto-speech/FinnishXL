...
all_ids=[]
space_counter=0
nf= open("data/cp_kiel_train3/yle_nbest_1000_ad_ab_.txt",'w')
with open('/m/triton/scratch/elec/puhe/p/jaina5/transformer-xl/FinnishXL/yle_nbest_1000_ad_ab', "r", encoding="utf-8") as reader:
    while True:
...
for model_dir in model_dirs:
    ...
    #             tokens.append([line])
    #     return tokens
    re=open("rescore_yle_dev/yle_nbest_1000_ad_ab_"+model_dir,'w')
    def rescore():
        encoded_sent=corpus.vocab.encode_file(path='/m/triton/scratch/elec/puhe/p/jaina5/transformer-xl/FinnishXL/data/cp_kiel_train3/yle_nbest_1000_ad_ab_.txt',add_double_eos=True)
