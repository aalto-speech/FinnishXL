...
all_ids=[]
space_counter=0
nf= open("data/cp_kiel_train3/rescore_yle_test_nbest1000_20191112-102012_missingad.txt",'w')
with open('/m/triton/scratch/elec/puhe/p/jaina5/transformer-xl/FinnishXL/rescore_yle_test_nbest1000_20191112-102012_missingad', "r", encoding="utf-8") as reader:
    while True:
...
for model_dir in model_dirs:
    ...
    #             tokens.append([line])
    #     return tokens
    re=open("rescore_yle_test/rescore_yle_test_nbest1000_20191112-102012_missingad",'w')
    def rescore():
        encoded_sent=corpus.vocab.encode_file(path='/m/triton/scratch/elec/puhe/p/jaina5/transformer-xl/FinnishXL/data/cp_kiel_train3/rescore_yle_test_nbest1000_20191112-102012_missingad.txt',add_double_eos=True)
