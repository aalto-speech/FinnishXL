...
parser.add_argument('--cuda', action='store_true',
                    help='use CUDA')
parser.add_argument('--work_dir', type=str, default='/m/triton/scratch/elec/puhe/p/jaina5/transformer-xl/FinnishXL/-Ktrain/20190815-205709-test/',
...
all_ids=[]
space_counter=0
nf= open("data/cp_kiel_train3/test_tr38.txt",'w')
...
#             tokens.append([line])
#     return tokens
re=open("rescore_2_tr38_1000.txt",'w')
def rescore():
    encoded_sent=corpus.vocab.encode_file(path='/m/triton/scratch/elec/puhe/p/jaina5/transformer-xl/FinnishXL/data/cp_kiel_train3/test_tr38.txt',add_double_eos=True)
