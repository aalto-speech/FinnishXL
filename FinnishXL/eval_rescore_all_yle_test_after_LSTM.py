...
all_ids=[]
space_counter=0
nf= open("data/cp_kiel_train3/yle_test_nbest_50_after_LSTM_lattice.txt",'w')
with open('/m/triton/scratch/elec/puhe/p/jaina5/yle_test_nbest_50_after_LSTM_lattice', "r", encoding="utf-8") as reader:
    while True:
...
model_dirs=['20191112-102012','20191022-134318','20191119-133110']
for model_dir in model_dirs:
    ...
    #             tokens.append([line])
    #     return tokens
    re=open("rescore_yle_test/yle_test_nbest_50_after_LSTM_lattice"+model_dir,'w')
    def rescore():
        encoded_sent=corpus.vocab.encode_file(path='/m/triton/scratch/elec/puhe/p/jaina5/transformer-xl/FinnishXL/data/cp_kiel_train3/yle_test_nbest_50_after_LSTM_lattice.txt',add_double_eos=True)
